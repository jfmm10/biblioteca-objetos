...
class Coleccion
{
    public:
		...
		void agregarLibro(string nombre,int edicion,string autor,int id,string genero);
		void agregarrevista(string nombre,int Id,int edicion,string materia,string fecha);
